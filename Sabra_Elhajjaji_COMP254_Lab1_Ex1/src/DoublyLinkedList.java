...
public class DoublyLinkedList<E> {
    ...
    public void concatenate(DoublyLinkedList<E> secondList){
        ...
        if(secondList.isEmpty()) return ;
            ...
            Node<E> lastNodeOfFirstList = this.trailer.getPrev();
            Node<E> firstNodeOfSecondList = secondList.header.getNext();
            lastNodeOfFirstList.setNext(firstNodeOfSecondList);
            firstNodeOfSecondList.setPrev(lastNodeOfFirstList);
            Node<E> lastNodeOfSecondList = secondList.trailer.getPrev();
            lastNodeOfSecondList.setNext(this.trailer);
            this.trailer.setPrev(lastNodeOfSecondList);
